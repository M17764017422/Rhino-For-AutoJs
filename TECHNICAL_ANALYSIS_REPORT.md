...
| 版本 | 特性 |
|------|------|
| ES2019 | `Array.prototype.flat`, `flatMap`<br>`Object.fromEntries`<br>`String.prototype.trimStart`, `trimEnd` |
| ES2020 | 可选链 (`?.`)<br>空值合并 (`??`)<br>`globalThis` |
| ES2021 | 逻辑赋值运算符 (`??=`, `||=`, `&&=`) |
| ES2022/ES2023/ES2025 | `Promise.withResolvers`<br>`Promise.try`<br>ArrayBuffer传输方法<br>新Set方法 |
